...
let statusAdresseNr = document.querySelector(".statusMessage.adresseNr")
...
statusEtage.innerHTML = "";
statusBy.innerHTML = "";
statusAdresseNr.innerHTML = "";
...
statusEfternavn.innerHTML = "";
        ...
        if(form.adresseNr.value == ""){
            statusAdresseNr.innerHTML= "<- Skriv dit vej/gade nummer her"
            status = false;
        }
        if(form.etage.value == ""){
            statusEtage.innerHTML= "<- Skriv din etage her"
            status = false;
        }
